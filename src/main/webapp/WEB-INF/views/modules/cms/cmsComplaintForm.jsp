...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/cms/cmsComplaint/">投诉列表</a></li>
		<li class="active"><a href="${ctx}/cms/cmsComplaint/form?id=${cmsComplaint.id}">投诉<shiro:hasPermission name="cms:cmsComplaint:edit">${not empty cmsComplaint.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="cms:cmsComplaint:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
