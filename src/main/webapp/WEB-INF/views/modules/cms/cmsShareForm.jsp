...
<body>
	...
	<form:form id="inputForm" modelAttribute="cmsShare" action="${ctx}/cms/cmsShare/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label">分享内容源id：</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label">分享用户id：</label>
			<div class="controls">
				<sys:treeselect id="user" name="user.id" value="${cmsShare.user.id}" labelName="user.name" labelValue="${cmsShare.user.name}"
					title="用户" url="/sys/office/treeData?type=3" cssClass="" allowClear="true" notAllowSelectParent="true"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">分享平台  比如QQ、微信：</label>
			<div class="controls">
				<form:input path="platform" htmlEscape="false" maxlength="100" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<%--<shiro:hasPermission name="cms:cmsShare:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>--%>
