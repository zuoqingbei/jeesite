...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/reports/thinkerReports/list">报表管理列表</a></li>
		<li class="active"><a href="${ctx}/reports/thinkerReports/form?id=${thinkerReports.id}">报表管理<shiro:hasPermission name="reports:thinkerReports:edit">${not empty thinkerReports.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="reports:thinkerReports:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="thinkerReports" action="${ctx}/reports/thinkerReports/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>		
		<div class="control-group">
			<label class="control-label">显示系统：</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label">报表路径：</label>
			<div class="controls">
				<form:input path="path" htmlEscape="false" maxlength="400" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">报表地址：</label>
			<div class="controls">
				<form:input path="url" htmlEscape="false" maxlength="400" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="dimension" htmlEscape="false" maxlength="400" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="reports:thinkerReports:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
