                ...
                <div class="slide-offset">
                    <div class="swiper-container">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide"><img src="${ctxStatic}/${portalPage}/thinker/images/1.png" alt=""
                                                           class="slide-img"><span>财务运营</span></div>
                            <div class="swiper-slide"><img src="${ctxStatic}/${portalPage}/thinker/images/2.png" alt=""
                                                           class="slide-img"><span>智慧生活</span></div>
                            <div class="swiper-slide"><img src="${ctxStatic}/${portalPage}/thinker/images/3.png" alt=""
                                                           class="slide-img"><span>开放式创新</span></div>
                            <div class="swiper-slide"><img src="${ctxStatic}/${portalPage}/thinker/images/4.png" alt=""
                                                           class="slide-img"><span>职能创新</span></div>
                            <div class="swiper-slide"><img src="${ctxStatic}/${portalPage}/thinker/images/1.png" alt=""
                                                           class="slide-img"><span>财务运营</span></div>
                            <div class="swiper-slide"><img src="${ctxStatic}/${portalPage}/thinker/images/2.png" alt=""
                                                           class="slide-img"><span>智慧生活</span></div>
