...
/**
 * 
 * @className HttpRequestDeviceUtils.java
 * @time   2018年3月3日 上午11:09:32
 * @author zuoqb
 * @todo   判断http请求的来源设备类型
 */
public class HttpRequestDeviceUtils {
    ...
    "WAP2.0",//支持wap 2.0的
    "MQQBrowser",//MQQBrowser 为 QQ 手机浏览器，QQ 手机的Agent 比较特殊，所以单独判断
    "Windows Phone"
    };
    /**
     * 
     * @time   2018年3月3日 上午11:10:49
     * @author zuoqb
     * @todo   根据当前请求的特征，判断该请求是否来自手机终端，主要检测特殊的头信息，以及user-Agent这个header
    ...
    /**
     * 
     * @time   2018年3月3日 上午11:10:39
     * @author zuoqb
     * @todo  获取用户手机客户端系统是安卓还是苹果
     * @param  @param request
     * @param  @return
     * @return_type   String
     */
    public static String msystem(HttpServletRequest request){
    	String msystem="";
    	if(isMobileDevice(request)){
    		String userAgent = request.getHeader("user-agent");
    		if(userAgent.contains("iPhone") || userAgent.contains("iPad")){
    			msystem="IOS";//转向IOS 下载地址
    		}else if(userAgent.contains("Android")){
    			msystem="Android";//转向Android下载地址
    		}
    	}
    	return msystem;
    }
	 ...
	 * @return_type   boolean
	 */
	public static boolean isAjaxRequet(HttpServletRequest request){
